...
`asdf-table-schemas's github page <https://github.com/asdf-format/asdf-table-schemas>`_.
...
.. note::
    ASDF-table-schemas is mostly a collection of schemas for the ASDF format. This means that
