...
The ASDF Table Schemas define a set of schemas for serializing tables format. Currently only
:ref:`astropy.table <astropy:astropy-table>` is supported for the ASDF file format. These schemas
...
.. note::
   This is only a schema package, to use these schemas to serialize tables,
